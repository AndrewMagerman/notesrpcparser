...
public class LineParserTest extends TestCase {
    ...
    String testLineANotes9 = new String(
	    "[0F00:0002-0EA8] (4-48 [19]) ISDB2_RQST: 130 ms. [14+16=30]");
    ...
    String testLineC = new String(
	    "(11-13 [13]) CLOSE_DB(REP80256592:003E0158): 0 ms. [14+0=14]");
	...
	Line l = new Line(
		"[0F00:0002-0EA8] (53-73 [122]) OPEN_NOTE(REP862572C6:006BEDBE-NT0001D4F2,00400000): 153 ms. [48+1658=1706]");
	l.parse();
	...
	Line s = new Line(
		"[0F00:0002-0EA8] (321-153 [390]) GET LAST INDEX TIME(REP862572C6:006BEDBE): 134 ms. [14+76=90]");
	s.parse();
	...
	Line q = new Line(
		"(158-132 [163]) OPEN_NOTE(REPC1257B28:0056D462-NTFFFF0010,03000400): 0 ms. [56+2208=2264]");
	q.parse();
    ...
    public void testProfileDoc() {
  	...
  	Line t = new Line("[0D30:0002-0C18] (63-50 [143]) OPEN_NOTE_UNIDNAME_RQST(REP86257A75:00455282-$profile_014fa_translation_global~en,00400020): 34 ms. [94+3096=3190]");
  	t.parse();
	...
	assertEquals("A55BAE\\mail\\Andrew_Magerman.nsf",
		andrew.getParsedDBFilePath());
	...
	assertEquals(
		"[0F00:0002-0EA8] (28-57 [77]) OPEN_NOTE(REP862572C6:006BEDBE-NTFFFF0010,03000400): ",
		splitted.get(0));
	assertEquals(
	...
	assertEquals(
		"(181-133 [186]) OPEN_COLLECTION(REPC1257B28:0056D462-NTFFFF0020,0040,4000): ",
		splittedb.get(0));
	assertEquals(
	...
	assertEquals("[0DD0:0002-0D1C] (3-51 [19]) SV_INFO_GET_RQST: ",
		splittedd.get(0));
	assertEquals(
		"[0F3C:0007-0D3C:wrepl] (Opened: REP862572C6:006BEDBE) 137 ms. [134+290=424]",
		splittedd.get(1));
